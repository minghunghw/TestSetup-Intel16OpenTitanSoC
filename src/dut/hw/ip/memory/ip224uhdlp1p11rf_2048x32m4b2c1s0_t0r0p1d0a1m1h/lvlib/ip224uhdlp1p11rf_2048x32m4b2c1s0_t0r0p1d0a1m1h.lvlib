...
//ArrayRTLHier:ip224uhdlp1p11rf_2048x32m4b2c1s0_t0r0p1d0a1m1h_bmod.ip224uhdlp1p11rf_2048x32m4b2c1s0_t0r0p1d0a1m1h_array.DATA_ARRAY[Address][din]
MemoryTemplate ( ip224uhdlp1p11rf_2048x32m4b2c1s0_t0r0p1d0a1m1h ) {
  MemoryType:    SRAM;
  CellName:      ip224uhdlp1p11rf_2048x32m4b2c1s0_t0r0p1d0a1m1h;
  LogicalPorts:  1RW;
  ...
  PhysicalAddressMap {
    ...
    Port (deepslp)     { Direction: Input; Function: None; Polarity: ActiveHigh; SafeValue: 1'b0; }
    ...
    Port (mpr)         { Direction: Output; Function: None; }
