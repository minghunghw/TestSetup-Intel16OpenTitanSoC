...
x_write_addr: `ip224uhdlp1p11rf_2048x32m4b2c1s0_t0r0p1d0a1m1h_ASSERT_FORBIDDEN($isunknown(adr_fw_1l) && ckgrid && wren_fw_1l && (|(~wrbiten_b_fw_1l)) && chip_enable ,0)
...
x_read_addr: `ip224uhdlp1p11rf_2048x32m4b2c1s0_t0r0p1d0a1m1h_ASSERT_FORBIDDEN($isunknown(adr_fw_1l) && ckgrid && rden_fw_1l && chip_enable,0)
...
x_wbe: `ip224uhdlp1p11rf_2048x32m4b2c1s0_t0r0p1d0a1m1h_ASSERT_FORBIDDEN($isunknown(wrbiten_b_fw_1l) && ckgrid && wren_fw_1l && chip_enable ,0)
