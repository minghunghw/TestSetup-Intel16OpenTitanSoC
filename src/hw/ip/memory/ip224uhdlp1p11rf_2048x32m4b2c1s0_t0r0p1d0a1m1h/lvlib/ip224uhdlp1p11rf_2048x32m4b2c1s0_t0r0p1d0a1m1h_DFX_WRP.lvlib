...
//ArrayRTLHier:ip224uhdlp1p11rf_2048x32m4b2c1s0_t0r0p1d0a1m1h.ip224uhdlp1p11rf_2048x32m4b2c1s0_t0r0p1d0a1m1h_bmod.ip224uhdlp1p11rf_2048x32m4b2c1s0_t0r0p1d0a1m1h_array.DATA_ARRAY[Address][din]
MemoryTemplate ( ip224uhdlp1p11rf_2048x32m4b2c1s0_t0r0p1d0a1m1h_DFX_WRP ) {
	  MemoryType:    SRAM;
	  CellName:      ip224uhdlp1p11rf_2048x32m4b2c1s0_t0r0p1d0a1m1h_DFX_WRP;
	  LogicalPorts:  1RW;
	  OperationSet: SyncWR;
	  ATD : off;
	  ...
	  MilliWattsPerMegaHertz : 0.005939797013506584;
	  ...
	  AddressCounter {
          ...
          RowAddress[3] :  Address [6]; 
          RowAddress[4] :  Address [7]; 
          RowAddress[5] :  Address [8]; 
          RowAddress[6] :  Address [9]; 
          RowAddress[7] :  Address [10]; 
      ...
      RowAddress[7] : r[7];
	    ...
	    Port (wen)         { Direction: Input; Function: WriteEnable; DisableDuringScan: Off; Polarity: ActiveHigh;  }
	    ...
	    Port (iso)         { Direction: Input; Function: None; Polarity: ActiveHigh; SafeValue: 1'b0; }

	    Port (sleep)       { Direction: Input; Function: None; Polarity: ActiveHigh; SafeValue: 1'b0; }
	    Port (deepsleep)     { Direction: Input; Function: None; Polarity: ActiveHigh; SafeValue: 1'b0; }
	    Port (shutoff)     { Direction: Input; Function: None; Polarity: ActiveHigh; SafeValue: 1'b0; }
	    Port (bc1)         { Direction: Input; Function: None; Polarity: ActiveHigh; SafeValue: 1'b0; }
	    Port (bc2)         { Direction: Input; Function: None; Polarity: ActiveHigh; SafeValue: 1'b0; }
	    Port (shutoff_out)         { Direction: Output; Function: None; }
