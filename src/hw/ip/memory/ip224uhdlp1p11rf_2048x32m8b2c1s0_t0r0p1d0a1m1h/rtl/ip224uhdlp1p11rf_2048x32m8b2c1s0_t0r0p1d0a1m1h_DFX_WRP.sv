...
`ifndef _ip224uhdlp1p11rf_2048x32m8b2c1s0_t0r0p1d0a1m1h_DFX_WRP_sv_
`define _ip224uhdlp1p11rf_2048x32m8b2c1s0_t0r0p1d0a1m1h_DFX_WRP_sv_

//`include "ip224uhdlp1p11rf_2048x32m8b2c1s0_t0r0p1d0a1m1h.sv"


//------------------------------------------------------------------------  
`define ip224uhdlp1p11rf_2048x32m8b2c1s0_t0r0p1d0a1m1h_DFX_WRP_LATCH(q,d,clock)         \
   always_latch                                                 \
      begin                                                     \
         if(clock)                                              \
              q <= d;                                           \
...
//------------------------------------------------------------------------  
module ip224uhdlp1p11rf_2048x32m8b2c1s0_t0r0p1d0a1m1h_DFX_WRP_RESET_FF(q,d,clock,en,reset); // lintra s-68099
...
module ip224uhdlp1p11rf_2048x32m8b2c1s0_t0r0p1d0a1m1h_DFX_WRP #( // lintra s-68000
...
ip224uhdlp1p11rf_2048x32m8b2c1s0_t0r0p1d0a1m1h ip224uhdlp1p11rf_2048x32m8b2c1s0_t0r0p1d0a1m1h (
