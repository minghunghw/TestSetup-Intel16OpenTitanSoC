...
void __vcs_export_dpi_dummy_references__()
{
    extern void simutil_get_scramble_key(void);
    void (*fp0)(void) = (void (*)(void)) simutil_get_scramble_key;
    fp0 = fp0;
    extern void simutil_get_scramble_nonce(void);
    void (*fp1)(void) = (void (*)(void)) simutil_get_scramble_nonce;
    fp1 = fp1;
}
